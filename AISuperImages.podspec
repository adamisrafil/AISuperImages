...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
"AISuperImages is a CocoaPod that extends the UIIamgeView class with a convenience method for rounding the image view with a specified border color and width."
                       DESC
